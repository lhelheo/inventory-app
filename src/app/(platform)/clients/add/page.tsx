...
export default function CreateClient() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col w-full h-screen max-w-md mx-auto justify-center items-center gap-6 p-6 bg-white shadow-lg rounded-lg">
