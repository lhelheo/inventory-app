  ...
  return (
    <div className='flex flex-col h-screen justify-center items-center'>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex gap-4 mt-4">
          <button onClick={() => router.push('/products/client')} className="cursor-pointer bg-white rounded-lg p-2 ease-linear transition-all text-blue-500 hover:text-blue-700">Adicionar produto</button>
        </div>
      </div>
    </div>
  );
